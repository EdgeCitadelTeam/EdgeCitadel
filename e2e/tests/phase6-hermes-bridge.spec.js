// Phase 6 E2E — Hermes Managed Adapter.
// Requires: hermes serve running on :8642 (or a mock fixture), and
// the Managed Adapter running with HERMES_TOKEN_FILE configured.
...
test.describe('Phase 6 — Hermes bridge', () => {
  ...
  test('us-mac-hermes registers with bridge runtime kind', async ({ request }) => {
    ...
    test.skip(!card, 'us-mac-hermes not online — install and start the Hermes Managed Adapter to run this spec');
