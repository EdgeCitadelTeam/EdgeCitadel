...
import adapters._common.pull_consumer as pull_consumer_module
import adapters._common.template as template_module
from adapters._common.pull_consumer import ConsumerBinding, Context, PullConsumer
...
async def test_legacy_run_uses_bootstrap_and_historical_subscription(
    ...
    async def fake_ensure_stream(js: object) -> None:
        calls.append(("stream", js))
