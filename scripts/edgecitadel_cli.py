"""Unified newcomer CLI for EdgeCitadel source deployments."""
...
IS_HOMEBREW = os.environ.get("EDGECITADEL_DISTRIBUTION") == "homebrew"
CORE_RUNTIME_DIR = Path(
    os.environ.get(
        "EDGECITADEL_CORE_DIR",
        Path.home() / ".edgecitadel" / "core" if IS_HOMEBREW else INSTALL_ROOT,
    )
).expanduser()
...
def _command_name() -> str:
    return "edgecitadel" if IS_HOMEBREW else "./scripts/edgecitadel"
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="edgecitadel",
        description="Create, join, and operate an EdgeCitadel source deployment.",
    )
