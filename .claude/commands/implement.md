...
3. If you encounter something the plan did NOT anticipate:
   ...
   - Explain what you found and why it differs from expectations
   - Propose an adjustment to the plan
   - Wait for approval before continuing
4. After all phases are complete:
   - Run the full test suite
   - Summarize all changes made (files modified, lines changed)
   - Note any deviations from the original plan
   - List any follow-up work or tech debt introduced
